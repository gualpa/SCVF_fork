 ...
 *
 * @param VarConfigAux estructura con las variables de configuración del programa
 *        valore usados VarConfig.logfile, VarConfig.NumTrac, VarConfig.DeltaSeed, VarConfig.NumVoid
 *                      VarConfig.StepName, VarConfig.StepTime
